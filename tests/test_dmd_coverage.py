...
def test_check_inputs_hankel_missing_time_mapping(svd_results: SVDResults) -> None:
...
def test_modes_std_averaged_without_hankel(fitted_optdmd_bagging: OptDMD) -> None:
